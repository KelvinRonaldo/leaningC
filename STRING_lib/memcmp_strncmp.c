...
int main(void){
	...
	/*
		...
		(buffers a serem comparados não necessariamente não precisam ter o mesmo tamanho)
		...
		-quando encontra uma divergencia, retorna a diferença do código ASCII do byte primeiro buffer com o byte
		...
		*STRNCMP funciona praticamente da mesma forma, mas compara strings e não blocos de memoria(buffers)	
	*/
